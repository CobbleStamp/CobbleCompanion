...
| Missions (goal-driven long-running tasks — design; Tools spine + companion build shipped, integration dry-run pending) | `docs/plans/companion-missions.md` (build plan + status: `docs/plans/missions-implementation-plan.md`) |
