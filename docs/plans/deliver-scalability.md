...
- **Handoff = "the companion moves rooms."** A new connection **force-claims**
  ...
  write, and closes. The client presents this as the companion _physically moving_
